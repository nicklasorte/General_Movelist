function part0_deployment_pts_folders_bs_azi_rev3(app,sim_number,bs_eirp_reductions,rev_folder,tf_server_status,cell_sim_data,base_station_latlonheight,sim_radius_km,FreqMHz)
    ...
    for folder_idx=1:1:num_folders
        ...
        if cell_status{temp_cell_idx,2}==0
            ...
            if var_exist==2
                ...
                sim_array_list_bs(:,6)=base_station_latlonheight(bs_inside_idx,5);
