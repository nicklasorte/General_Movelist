...
%%move_list_margin=load_variable_with_retry(app,'move_list_margin.mat','move_list_margin'); %%%%%%%%%This function didn't work on the server app
...
%%%%%%%part2_neigh_calc_rev14_agg_check_chunk(app,parallel_flag,rev_folder,workers,move_list_reliability,mc_size,mc_percentile,reliability,norm_aas_zero_elevation_data,string_prop_model,sim_radius_km,min_binaray_spacing,margin,maine_exception,tf_full_binary_search,agg_check_reliability,tf_opt,tf_recalculate,tf_server_status,tf_print_excel,bs_eirp_dist,cell_aas_dist_data,move_list_margin,cell_sim_data,tf_full_turnoff)
%part2_neigh_calc_rev15_agg_check_chunk_man_azi(app,parallel_flag,rev_folder,workers,move_list_reliability,mc_size,mc_percentile,reliability,norm_aas_zero_elevation_data,string_prop_model,sim_radius_km,min_binaray_spacing,margin,maine_exception,tf_full_binary_search,agg_check_reliability,tf_opt,tf_recalculate,tf_server_status,tf_print_excel,bs_eirp_dist,cell_aas_dist_data,move_list_margin,cell_sim_data,tf_full_turnoff)
%%%%part2_neigh_calc_rev16_mc_chunk_man_azi(app,parallel_flag,rev_folder,workers,move_list_reliability,mc_size,mc_percentile,reliability,norm_aas_zero_elevation_data,string_prop_model,sim_radius_km,min_binaray_spacing,margin,maine_exception,tf_full_binary_search,agg_check_reliability,tf_opt,tf_recalculate,tf_server_status,tf_print_excel,cell_aas_dist_data,move_list_margin,cell_sim_data,tf_full_turnoff,array_mitigation)
...
if ~all(array_mitigation==0)
    ...
    %part3_neighborhood_miti_movelist_census2020_superdist_rev9(app,parallel_flag,rev_folder,workers,move_list_reliability,mc_size,mc_percentile,reliability,norm_aas_zero_elevation_data,string_prop_model,tf_opt,tf_server_status,tf_recalculate,array_mitigation,bs_eirp_dist,cell_aas_dist_data)
