function [move_sort_sim_array_list_bs]=pre_sort_movelist_rev8_string_prop_model_neighborhood_cut_app(app,move_list_reliability,point_idx,sim_number,mc_size,radar_beamwidth,base_protection_pts,min_ant_loss,radar_threshold,mc_percentile,sim_array_list_bs,data_label1,reliability,norm_aas_zero_elevation_data,string_prop_model,single_search_dist,tf_opt)
...
% movelist_file_name=strcat(string_prop_model,'_move_list_turn_off_idx_',num2str(min(move_list_reliability)),'_',num2str(max(move_list_reliability)),'_',num2str(point_idx),'_',num2str(sim_number),'_',num2str(mc_size),'_',num2str(single_search_dist),'km.mat');
% [var_exist_movelist]=persistent_var_exist_with_corruption(app,movelist_file_name);
% 
% keep_idx_file_name=strcat(string_prop_model,'_keep_idx_',num2str(min(move_list_reliability)),'_',num2str(max(move_list_reliability)),'_',num2str(point_idx),'_',num2str(sim_number),'_',num2str(mc_size),'_',num2str(single_search_dist),'km.mat');
% [var_exist_keep_idx]=persistent_var_exist_with_corruption(app,keep_idx_file_name);
% 
% sort_idx_file_name=strcat(string_prop_model,'_sort_idx_',num2str(min(move_list_reliability)),'_',num2str(max(move_list_reliability)),'_',num2str(point_idx),'_',num2str(sim_number),'_',num2str(mc_size),'_',num2str(single_search_dist),'km.mat');
% [var_exist_sort_idx]=persistent_var_exist_with_corruption(app,sort_idx_file_name);
...
if var_exist_move_sort==2%%var_exist_movelist==2 && var_exist_keep_idx==2 && var_exist_sort_idx==2 && var_exist_move_sort==2
    %%%%%%%%%%%load
    retry_load=1;
    while(retry_load==1)
        try
%             load(movelist_file_name,'move_list_turn_off_idx')
%             load(keep_idx_file_name,'keep_idx')
...
% % % %     while(retry_save==1)
% % % %         try
% % % % %             save(sort_idx_file_name,'sort_bs_idx')
% % % % %             save(keep_idx_file_name,'keep_idx')
% % % %             retry_save=0;
% % % %         catch
% % % %             retry_save=1
% % % %             pause(0.1)
