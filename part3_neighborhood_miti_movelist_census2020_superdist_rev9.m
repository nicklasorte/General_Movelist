function part3_neighborhood_miti_movelist_census2020_superdist_rev9(app,parallel_flag,rev_folder,workers,move_list_reliability,mc_size,mc_percentile,reliability,norm_aas_zero_elevation_data,string_prop_model,tf_opt,tf_server_status,tf_recalculate,array_mitigation,bs_eirp_dist,cell_aas_dist_data)
            ...
            if var_exist==2
                ...
                if file_union_move_exist==2
                    ...
                    for point_idx=1:1:num_ppts  %%%%%%%%This can be parfor
                        ...
                        %%%%%[cell_miti_list]=pre_sort_movelist_rev21b_miti_bsdist_app(app,move_list_reliability,point_idx,sim_number,mc_size,radar_beamwidth,base_protection_pts,min_ant_loss,radar_threshold,mc_percentile,sim_array_list_bs,data_label1,reliability,norm_aas_zero_elevation_data,string_prop_model,array_mitigation,tf_opt,min_azimuth,max_azimuth,neighborhood_radius,custom_antenna_pattern,bs_eirp_dist);
