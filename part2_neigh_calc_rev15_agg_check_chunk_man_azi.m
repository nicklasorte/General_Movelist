        ...
        if cell_status{temp_cell_idx,2}==0
            ...
            if var_exist==2
                ...
                while(tf_search==1)
                    ...
                    % 'Forcing to 0km for the aggregate check.'
                    % single_search_dist
                    % single_search_dist=0
                    ...
                    if any(temp_data_dist==single_search_dist)==1
                        ...
                        if var_exist_single_scrap_data==2
                            ...
                            if file_union_move_exist==2
                                ...
                                'Need to update movelist with tf_man_azi_step'
