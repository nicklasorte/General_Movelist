function neighborhood_wrapper_rev21_clutter_dual_man_azi_ua2023_zerorow(app,rev_folder,parallel_flag,tf_server_status,workers,tf_recalculate,tf_rescrap_rev_data,tf_print_excel)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[maine_exception]=load_data_maine_exception(app);  %%%%Removing this
...
[bs_eirp_dist]=load_data_bs_eirp_dist(app);
[cell_aas_dist_data]=load_data_cell_aas_dist_data(app);
[move_list_margin]=load_data_move_list_margin(app);
[tf_full_turnoff]=load_data_tf_full_turnoff(app);
[tf_test]=load_data_tf_test(app)
server_status_rev2(app,tf_server_status)


%%%'Later: Update part 0 with changing to spereical coordinates'


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Step 0: Make the grid points
disp_TextArea_PastText(app,strcat('Entering into Part0: Creating Grid Points'))
%%%%%part0_deployment_pts_folders_clutter_idx_rev6(app,sim_number,bs_eirp_reductions,rev_folder,tf_server_status,cell_sim_data,base_station_latlonheight,sim_radius_km,FreqMHz)
part0_deployment_pts_folders_p2p_add_rev7(app,sim_number,bs_eirp_reductions,rev_folder,tf_server_status,cell_sim_data,base_station_latlonheight,sim_radius_km,FreqMHz)
...
part1_calc_pathloss_clutter2108_dist_max64_rev14(app,rev_folder,parallel_flag,reliability,confidence,FreqMHz,Tpol,workers,string_prop_model,tf_recalc_pathloss,tf_server_status,tf_clutter)
server_status_rev2(app,tf_server_status)
...
%part2_neigh_calc_rev17_mc_chunk_tf_test(app,parallel_flag,rev_folder,workers,move_list_reliability,mc_size,mc_percentile,reliability,norm_aas_zero_elevation_data,string_prop_model,sim_radius_km,min_binaray_spacing,margin,maine_exception,tf_full_binary_search,agg_check_reliability,tf_opt,tf_recalculate,tf_server_status,tf_print_excel,cell_aas_dist_data,move_list_margin,cell_sim_data,tf_full_turnoff,array_mitigation,tf_test)
part2_neigh_calc_rev19_mc_chunk_pop(app,parallel_flag,rev_folder,workers,move_list_reliability,mc_size,mc_percentile,reliability,norm_aas_zero_elevation_data,string_prop_model,sim_radius_km,min_binaray_spacing,margin,maine_exception,tf_full_binary_search,agg_check_reliability,tf_opt,tf_recalculate,tf_server_status,tf_print_excel,cell_aas_dist_data,move_list_margin,cell_sim_data,tf_full_turnoff,array_mitigation,tf_test)



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%'for part 3, if miti array is just zero, the mitigartion list is the union move list and we skip this step'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

if ~all(array_mitigation==0)

    %%%%%%%We will need to update the miti movelist for the dual I/N thresholds
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%'Now do the mitigation move list within the neighborhood.'
    %part3_neighborhood_miti_movelist_census2020_clutter_rev10(app,parallel_flag,rev_folder,workers,move_list_reliability,mc_size,mc_percentile,reliability,norm_aas_zero_elevation_data,string_prop_model,tf_opt,tf_server_status,tf_recalculate,array_mitigation,bs_eirp_dist,cell_aas_dist_data)
    part3_miti_ML_census2020_clutter_rev11_mc_chunks(app,parallel_flag,rev_folder,workers,move_list_reliability,mc_size,mc_percentile,reliability,norm_aas_zero_elevation_data,string_prop_model,tf_opt,tf_server_status,tf_recalculate,array_mitigation,cell_aas_dist_data,cell_sim_data,move_list_margin)
...
%%'Do the PEA/Urban Area overlap with each zone in rev12'
...
scrap_data_pop_geo_id_pea_ua_2023_rev12_zone(app,tf_rescrap_rev_data,sim_number,string_prop_model,array_mitigation,rev_folder,tf_server_status,reliability,tf_convex,tf_zero_row)
