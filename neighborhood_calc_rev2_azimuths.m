                             ...
                             if file_union_move_exist==2
                                ...
                                while(retry_load==1)
                                 ...
                                 for point_idx=1:1:num_ppts  %%%%%%%%This can be parfor
                                     point_idx
                                     %%%[move_sort_sim_array_list_bs]=pre_sort_movelist_rev8_string_prop_model_neighborhood_cut_app(app,move_list_reliability,point_idx,sim_number,mc_size,radar_beamwidth,base_protection_pts,min_ant_loss,radar_threshold,mc_percentile,sim_array_list_bs,data_label1,reliability,norm_aas_zero_elevation_data,string_prop_model,single_search_dist,tf_opt);
...
% % % %                                  end
                            ...
                            if parallel_flag==1
                                [poolobj,cores]=start_parpool_poolsize_app(app,parallel_flag,workers);
                                parfor point_idx=1:num_ppts  %%%%Change to parfor
                                         %%%agg_check_rev1_string_prop_model_app(app,agg_check_reliability,point_idx,sim_number,mc_size,radar_beamwidth,base_protection_pts,min_ant_loss,mc_percentile,on_list_bs,data_label1,reliability,norm_aas_zero_elevation_data,string_prop_model,single_search_dist,off_idx);
                            ...
                            for point_idx=1:1:num_ppts  %%%%%%%%This can be parfor
                                point_idx
                                %%%%%%%%%[array_agg_check_95]=agg_check_rev1_string_prop_model_app(app,agg_check_reliability,point_idx,sim_number,mc_size,radar_beamwidth,base_protection_pts,min_ant_loss,mc_percentile,on_list_bs,data_label1,reliability,norm_aas_zero_elevation_data,string_prop_model,single_search_dist,off_idx);
                ...
                tf_catb=1;
                single_mod_plateau_alg_rev5_name(app,data_label1,sim_number,radar_threshold,margin,maine_exception,CBSD_label,base_polygon,base_protection_pts,tf_catb)
                ...
                server_status_rev1(app)
                 disp_progress(app,strcat('Neighborhood Calc Rev1 Line 450: Updating Cell Status'))
                [cell_status]=update_generic_status_cell_rev1(app,folder_names,sim_folder,cell_status_filename);
            end
        end
