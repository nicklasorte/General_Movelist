function [opt_sort_bs_idx]=near_opt_sort_idx_string_prop_model_rev2(app,data_label1,point_idx,tf_calc_opt_sort,radar_beamwidth,min_ant_loss,sim_array_list_bs,base_protection_pts,temp_pr_dbm,string_prop_model)
        ...
        opt_sort_bs_idx_file_name=strcat(data_label1,'_',string_prop_model,'_opt_sort_bs_idx_',num2str(point_idx),'.mat');
