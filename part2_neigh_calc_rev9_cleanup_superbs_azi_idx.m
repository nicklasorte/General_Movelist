                    ...
                    if any(temp_data_dist==single_search_dist)==1
                        ...
                        if var_exist_single_scrap_data==2
                            ...
                            if file_union_move_exist==2
                                ...
                                % %     union_turn_off_list_data=NaN(1,15);
                                % % end
                                union_turn_off_list_data=build_union_turn_off_list(app,cell_move_list_turn_off_data);
                        ...
                        %%%%save_variable_with_retry(file_name_cell,'all_data_stats_binary',all_data_stats_binary,0.1);
                    end
